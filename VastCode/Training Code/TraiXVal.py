...
for i in trange(coarse_steps):  
  xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, opt_subkey, opt_key, mad, vad, xvalue = _CUpdate(i, xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, num_f, num_b, num_ind, num_filt, batch_size, k, n, indices, spikefft, xvel, ftime, opt_subkey, opt_key, mad, vad)
  xsigma_n = xsigma_n[0]
  xelbo_history[step] = -xvalue[0]
  step += 1

# %%
xoutdict = {"Parameters": (xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag),
          ...
          "vad": vad,
          "Velocity Trained": "x"}
with open('./Data/Hyperparameters/LinearSum/' + str(n) + '_' + str(attemptno) + 'xvel' + '.pkl', 'wb') as f:
    pickle.dump(xoutdict, f)

# %%
for i in trange(mid_steps): 
  xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, opt_subkey, opt_key, mad, vad, xvalue = _MUpdate(i, xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, num_f, num_b, num_ind, num_filt, batch_size, k, n, indices, spikefft, xvel, ftime, opt_subkey, opt_key, mad, vad)
  xsigma_n = xsigma_n[0]
  xelbo_history[step] = -xvalue[0]
  step += 1
...
for i in trange(fine_steps):  
  xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, opt_subkey, opt_key, mad, vad, xvalue = _FUpdate(i, xsigma_f, xell, xsigma_n, xz_fracs, xv_vector, xl_diag, xl_odiag, xtrise, xtaudiff, xlag, num_f, num_b, num_ind, num_filt, batch_size, k, n, indices, spikefft, xvel, ftime, opt_subkey, opt_key, mad, vad)
  xsigma_n = xsigma_n[0]
  xelbo_history[step] = -xvalue[0]
  step += 1
