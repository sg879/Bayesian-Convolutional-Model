...
loadpath = pt.abspath(pt.join(pt.dirname(__file__), '..', 'Data/Hyperparameters/LinearSum/' + str(n) + '_' + str(attemptno) + 'yvel' + '.pkl'))
...
savepath = pt.abspath(pt.join(pt.dirname(__file__), '..', 'Data/Hyperparameters/LinearSum/' + str(n) + '_' + str(attemptno) + '.' + str(attemptadd) + 'yvel' + '.pkl'))
